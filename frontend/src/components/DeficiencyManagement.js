        ...
        <div className="p-6">
          ...
          {showAddForm && (
            <div className="mb-6 p-4 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Description * (Type to generate recommendations)
                </label>
                <textarea
              ...
              {(recommendations.length > 0 || isGeneratingRecommendations) && (
                <div className="mt-4">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    {isGeneratingRecommendations && <span className="text-blue-600 ml-2">Generating...</span>}
                  </label>
                      ...
                      <div className="space-y-2">
                        {recommendations.map((rec, index) => (
                          <label key={index} className="flex items-start space-x-2 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={newDeficiency.recommendations.includes(rec)}
                              onChange={() => handleRecommendationSelect(rec)}
              ...
              {/* Auto-generated Incident Report Number Display */}
              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Incident Report Number (Auto-generated)
                </label>
                <div className="bg-gray-100 px-3 py-2 rounded-md text-sm text-gray-700">
                  Will be auto-generated: IR-{new Date().getFullYear()}{String(new Date().getMonth() + 1).padStart(2, '0')}{String(new Date().getDate()).padStart(2, '0')}-XXXX
                </div>
              </div>
